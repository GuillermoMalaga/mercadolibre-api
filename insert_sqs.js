...
async function sendMessageToSQS(messageBody, messageAttributes = {}) {
    ...
    const accessKeyId = 'AKIAWVCHXRXWHBMTP7ZI';
    const secretAccessKey = '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';
    const region = 'us-east-1';
    const queueUrl = 'https://sqs.us-east-1.amazonaws.com/457564458476/mgg-ml-webhook';
